...
var Root = (0, _styles.styled)(_IconButton["default"], {
...
function MiradorMenuButton(props) {
  ...
  var button = /*#__PURE__*/(0, _jsxRuntime.jsx)(Root, _objectSpread(_objectSpread({
    ownerState: props
  }, iconButtonProps), {}, {
    sx: sx,
    size: "large",
    children: badge ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_Badge["default"], _objectSpread(_objectSpread({
      overlap: "rectangular"
    }, BadgeProps), {}, {
      children: children
    })) : children
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tooltip["default"], _objectSpread(_objectSpread({
    PopperProps: {
