...
var StyledVisibleNode = (0, _styles.styled)('div')(function () {
  return {};
});
/** */
...
var ScrollToForTreeItem = function ScrollToForTreeItem(_ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ScrollTo.ScrollTo, _objectSpread(_objectSpread({}, props), {}, {
    children: children
  }));
};
/** */
  ...
  _createClass(SidebarIndexTableOfContents, [{
    ...
    value: function render() {
      ...
      var renderTree = function renderTree(node) {
        return /*#__PURE__*/(0, _jsxRuntime.jsx)(ScrollToForTreeItem, {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_TreeItem.TreeItem, {
            ...
            label: /*#__PURE__*/(0, _jsxRuntime.jsx)(StyledVisibleNode, {
              sx: function sx(theme) {
                var _theme$palette$highli;
                return {
                  backgroundColor: visibleNodeIds.indexOf(node.id) !== -1 && (0, _styles.alpha)(((_theme$palette$highli = theme.palette.highlights) === null || _theme$palette$highli === void 0 ? void 0 : _theme$palette$highli.primary) || theme.palette.action.selected, 0.35),
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_TreeView.TreeView, {
        sx: {
          flexGrow: 1
        },
