...
var OpenSeadragonViewer = exports.OpenSeadragonViewer = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OpenSeadragonViewer, [{
    ...
    value: function fitBounds(x, y, w, h) {
      ...
      var viewer = this.state.viewer;
      viewer && viewer.viewport && viewer.viewport.fitBounds(new _openseadragon["default"].Rect(x, y, w, h), immediately);
    }
    ...
    value: function render() {
      ...
      var enhancedChildren = _react.Children.map(children, function (child) {
        return /*#__PURE__*/(0, _react.cloneElement)(child, {
          zoomToWorld: _this4.zoomToWorld
        });
      });
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(StyledSection, {
        className: (0, _classnames["default"])((0, _cssNs["default"])('osd-container')),
        style: {
        ...
        "aria-live": "polite",
        children: [drawAnnotations && /*#__PURE__*/(0, _jsxRuntime.jsx)(_AnnotationsOverlay["default"], {
          viewer: viewer,
          windowId: windowId
        }), enhancedChildren, /*#__PURE__*/(0, _jsxRuntime.jsx)(_PluginHook.PluginHook, _objectSpread({
          viewer: viewer
