...
var MiradorCanvas = exports["default"] = /*#__PURE__*/function () {
  ...
  _createClass(MiradorCanvas, [{
    ...
    get: function get() {
      var _this2 = this;
      var resources = (0, _flattenDeep["default"])(this.canvasAnnotationPages.map(function (annoPage) {
        var manifestoAnnoPage = new _manifesto.AnnotationPage(annoPage, _this2.canvas.options);
        return manifestoAnnoPage.getItems().map(function (item) {
          var manifestoAnnotation = new _manifesto.Annotation(item, _this2.canvas.options);
